...
const LIST := {
	"classic": { "auto":false, "name":"Classic",  "cat":"pistol",  "cost":0,    "mag":12, "res":36, "fi":0.148, "rl":1.75, "dmg":{"h":78,  "b":26, "l":22}, "spread":0.35, "range":50 },
	"ghost": { "auto":false, "name":"Ghost",    "cat":"pistol",  "cost":500,  "mag":15, "res":45, "fi":0.148, "rl":1.8,  "dmg":{"h":105, "b":30, "l":26}, "spread":0.3,  "range":60 },
	"sheriff": { "auto":false, "name":"Sheriff",  "cat":"pistol",  "cost":800,  "mag":6,  "res":18, "fi":0.4,   "rl":2.3,  "dmg":{"h":159, "b":55, "l":47}, "spread":0.45, "range":60 },
	...
	"bucky": { "auto":false, "name":"Bucky",    "cat":"shotgun", "cost":850,  "mag":5,  "res":10, "fi":0.9,   "rl":2.5,  "dmg":{"h":40,  "b":20, "l":17}, "spread":2.6,  "range":22, "pellets":8 },
	...
	"guardian": { "auto":false, "name":"Guardian", "cat":"rifle",   "cost":2250, "mag":12, "res":36, "fi":0.165, "rl":2.5,  "dmg":{"h":195, "b":65, "l":49}, "spread":0.3,  "range":100 },
